...
| [`tools/reprobe-bindings/reprobe.mjs`](tools/reprobe-bindings/reprobe.mjs) | Ground-truth on upstream surface contracts. Re-runnable; CI-gateable. v0.5 tracks 31 npm + 1 CLI + 6 binding-method probes (M22+M23: subprocess-isolated, SIGKILL-on-timeout for hung NAPI calls per Issue #11; `'skipped'` status via exit code 64 for prerequisite-unavailable cases). Covers Issues #01/#03/#06/#09/#10/#11. |
